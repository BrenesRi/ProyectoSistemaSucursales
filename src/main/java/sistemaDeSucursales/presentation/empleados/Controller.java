...
public class Controller {
    ...
    public void imprimir()throws Exception {
        ...
        header.addCell(getCell(new Paragraph("Sistema de Empleados y Sucursales S.E.S").setFont(font).setBold().setFontSize(20f), TextAlignment.CENTER,false));
        ...
        body.addCell(getCell(new Paragraph("Salario Total").setBackgroundColor(bkg).setFontColor(frg),TextAlignment.CENTER,true));
        ...
        for(Empleado e: model.getEmpleados()){
            ...
            body.addCell(getCell(new Paragraph(String.valueOf(e.getSalario()+(e.getSalario()*e.getSucursal().getZonaje()/100))),TextAlignment.CENTER,true));
        }
        document.add(body);
        document.close();
    }
